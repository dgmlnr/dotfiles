...
return {
  ...
  },
  {
    ...
    -- Description: UI for cmdline/messages. Disabled: broken on Neovim 0.12
    -- (upstream has no updates since Nov-2025; its cmdline takeover throws on `:`).
    -- Native cmdline restored; notifications still handled by snacks.nvim.
    "folke/noice.nvim",
    enabled = false,
  },
  {
